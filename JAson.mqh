...
// The original DEBUG_PRINT_KEY macro causes compilation errors.
// It has been replaced with a safe, empty version to resolve the issue.
// JAson.mqh (replace your current macro with this)
